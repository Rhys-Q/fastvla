...
from fastvla.envs.configs import AlohaEnv, EnvConfig, LiberoEnv, PushtEnv
from fastvla.envs.utils import _call_make_env, _download_hub_file, _import_hub_module, _normalize_hub_result
...
def make_env(
    ...
    if "libero" in cfg.type:
        from fastvla.envs.libero import create_libero_envs
        ...
        from fastvla.envs.metaworld import create_metaworld_envs
