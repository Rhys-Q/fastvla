...
from fastvla.envs.configs import EnvConfig
from fastvla.utils.constants import OBS_ENV_STATE, OBS_IMAGE, OBS_IMAGES, OBS_STATE
from fastvla.utils.utils import get_channel_first_image_shape
...
def _download_hub_file(
    ...
    try:
        ...
        if not os.path.exists(local_file):
            raise FileNotFoundError(f"Could not find {file_path} in repository {repo_id}@{revision or 'main'}") from e
