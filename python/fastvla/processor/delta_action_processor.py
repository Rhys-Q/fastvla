...
class MapTensorToDeltaActionDictStep(ActionProcessorStep):
    ...
    def transform_features(
        ...
        for axis in ["x", "y", "z"]:
            features[PipelineFeatureType.ACTION][f"delta_{axis}"] = PolicyFeature(type=FeatureType.ACTION, shape=(1,))
...
class MapDeltaActionToRobotActionStep(RobotActionProcessorStep):
    ...
    def transform_features(
        ...
        for feat in ["enabled", "target_x", "target_y", "target_z", "target_wx", "target_wy", "target_wz"]:
            features[PipelineFeatureType.ACTION][f"{feat}"] = PolicyFeature(type=FeatureType.ACTION, shape=(1,))
