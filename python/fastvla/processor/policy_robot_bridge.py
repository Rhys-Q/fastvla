...
from fastvla.configs.types import FeatureType, PipelineFeatureType, PolicyFeature
from fastvla.processor import ActionProcessorStep, PolicyAction, ProcessorStepRegistry, RobotAction
...
class PolicyActionToRobotActionProcessorStep(ActionProcessorStep):
    ...
    def transform_features(self, features):
        for name in self.motor_names:
            features[PipelineFeatureType.ACTION][f"{name}.pos"] = PolicyFeature(type=FeatureType.ACTION, shape=(1,))
        return features
