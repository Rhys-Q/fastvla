...
from fastvla.teleoperators.teleoperator import Teleoperator
from fastvla.teleoperators.utils import TeleopEvents
...
class RewardClassifierProcessorStep(ProcessorStep):
    ...
    def __post_init__(self):
        ...
        if self.pretrained_path is not None:
            from fastvla.policies.sac.reward_model.modeling_classifier import Classifier
