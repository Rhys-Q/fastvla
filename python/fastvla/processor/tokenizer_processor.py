...
from fastvla.utils.constants import OBS_LANGUAGE_ATTENTION_MASK, OBS_LANGUAGE_TOKENS
...
class TokenizerProcessorStep(ObservationProcessorStep):
    ...
    def observation(self, observation: dict[str, Any]) -> dict[str, Any]:
        ...
        if target_device is not None:
            tokenized_prompt = {
                k: v.to(target_device) if isinstance(v, torch.Tensor) else v for k, v in tokenized_prompt.items()
            }
