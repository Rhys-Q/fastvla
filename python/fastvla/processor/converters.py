...
from fastvla.utils.constants import ACTION, DONE, OBS_PREFIX, REWARD, TRUNCATED
...
def transition_to_batch(transition: EnvTransition) -> dict[str, Any]:
    """
    Convert an `EnvTransition` back to the canonical batch format used in fastvla.
